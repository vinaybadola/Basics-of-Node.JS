...
/*
                                                       Reading a file.
Important:  Here all the methods will perform aysnchronously
...
process.on('uncaughtException',err =>{
 ...
 // But wait you see fs.readFile('read.txt')  instead of writin hard coded path we can use path module because in different enviroment files paths are different
...
/*  Here all methods are performed synchronously 
